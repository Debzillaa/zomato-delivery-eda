...
def clean_zomato_data(filepath):
    ...
    # 2. Clean hidden trailing spaces in all text columns (Updated to avoid Pandas Warning)
    # By passing ["object", "str"], we ensure compatibility with both old and new Pandas versions.
    ...
    # 6. Filter out extreme anomalies in distance (e.g. distance > 50km)
